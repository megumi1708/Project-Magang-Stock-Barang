...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Inventory Barang</a></nav>
                                    ...
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$stock;?></td>
                                                <td>
                                                <button type="button" class="btn btn-success btn-sm rounded-0" data-bs-toggle="modal" data-bs-target="#edit<?=$idb;?>" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></button>
                                                
                                                <button type="button" class="btn btn-danger btn-sm rounded-0" data-bs-toggle="modal" data-bs-target="#delete<?=$idb;?>" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></button>
                                                </td>
                                            </tr>
                                                <!-- The Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
        <input type="number" name="stock" placeholder="Stock Barang"class="form-control" require>
        <br>
